...
@Component
public class FilesystemBackupJobStarter {

    private static final Log logger = LogFactory.getLog(FilesystemBackupJobStarter.class);
    ...
    @Autowired
    public FilesystemBackupJobStarter(JobBuilderFactory jobBuilderFactory, JobLauncher jobLauncher, StepBuilderFactory stepBuilderFactory) {
