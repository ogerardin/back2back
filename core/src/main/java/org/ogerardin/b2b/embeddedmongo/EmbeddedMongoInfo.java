...
/**
 * This class is used to obtain information about the version of MongoDB used by Embedded Mongo.
 * The version and features are read from the resource config/application.properties
 *
 * The {@link #main} method prints the following information (one per line):
