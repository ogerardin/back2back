<template>
  <b-container>
    ...
    <b-form v-on:submit="addTarget">

      <b-form-group label="Type" label-for="type">
        <b-form-select id="type" v-model="target._class" :options="options" class="mb-3" />
      </b-form-group>
      ...
      <template v-if="target._class=='.PeerTarget'">
        <b-form-group label="Hostname" label-for="host">
          <b-form-input id="host" v-model="target.hostname"></b-form-input>
        </b-form-group>
        <b-form-group label="Port" label-for="port">
          <b-form-input id="port" v-model="target.port"></b-form-input>
        </b-form-group>
      </template>
